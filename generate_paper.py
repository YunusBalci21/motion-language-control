...
Creates LaTeX/Markdown document from training results
"""
...
"""
    ...
    print("✓ Created research_paper_draft.md")
    print("  Ready for conversion to LaTeX/PDF")
    
    # Create LaTeX version too
    generate_latex_version()


def generate_latex_version():
    """Generate LaTeX version for journal submission"""
...
"""
    ...
    print("✓ Created research_paper.tex")
    print("  Compile with: pdflatex research_paper.tex")


if __name__ == "__main__":
    generate_paper_markdown()
    print("\n" + "="*60)
    print("PAPER FILES CREATED:")
    print("  1. research_paper_draft.md - Full draft in Markdown")
    print("  2. research_paper.tex - LaTeX template")
    print("\nNext steps:")
    print("  1. Review and edit content")
    print("  2. Add figures (training curves, robot images)")
